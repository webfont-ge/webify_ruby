...
{<img src="https://khancdn.eu/badges.php?key=codename&value=lazi&color=blue" height="18" alt="Gem Version" />}[https://github.com/dachi-gh/webify_ruby/releases/tag/v0.0.1]
